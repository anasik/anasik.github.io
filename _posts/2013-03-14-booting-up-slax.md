...
On Feb 18, I posted about [Slax &#8211; A Plug and Play OS](http://anasismail.com/slax-a-plug-and-play-operating-system/), which is absolutely free, but often, some people who are not much into computers, have trouble installing it. The simple + quick method is:
  ...
  1. <span style="line-height: 15px;"><a href="http://slax.org/downloads.php">Download Slax</a>. ZIP or ISO doesnt make much difference but personally, i prefer ISO. (and if you are not sure whether ur computer supports 64 bit or not, just download  the 32 bit version, which is recommended.)</span>
