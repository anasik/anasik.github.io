...
From what I can make out after reading [this](https://launchpad.net/ubuntustart), in itself, the project is more of a campaign to gain more users than a new redefined OS. Means that despite its _purpose,_  and how _big_ the whole thing sounds, 50% of the project is just about persuading people to switch to Ubuntu, while the rest i.e. the software bit of the project is a script that has to be run _after installing ubuntu,_ that would kinda enhance it for windows users so that they don&#8217;t have trouble getting used to the new environment, e.g. _moving window buttons from left to right 😀 ._ Auto-mounting NTFS drives, (cause we are too lazy to make a single click), and it also installs GIMP, WINE, DropBox, some torrent client, and other such tools that one _might_ need.
