...
The VM is sort of pre-configured with NodeJS, PHP, Apache, MySQL e.t.c. and you can always install whatever packages you need. You can import personal projects from your disk, into the cloud, and you can also create new ones, using a few presets for a start. The _presets_ here refers to _Bootstrap, AngularJS, WordPress_ e.t.c. So the idea is that it would just create all the necessary files, and prevent you with like a template that you are free to edit to suit your needs.
