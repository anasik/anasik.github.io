...
RAID, short for _Redundant-Array-of-Independent-Disks_, which bundles a group of hard-drives, in such a way that they function as a single _super-drive._ There are a few different kinds of RAID, each with its unique features and advantages.

A Storage-Pool, is similar to a RAID drive, or more like, a _user-friendly-home-applicable_ form of a RAID drive, that too brings multiple hard-drives or partitions together, so that they function as one _pooled-drive._