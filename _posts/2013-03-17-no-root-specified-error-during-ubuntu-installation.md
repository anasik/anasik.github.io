...
Firstly, make sure that the partition where you are installing ubuntu is an ext4 partition, and  dont leave _mount point_ empty. To do so, just double click the partition, and in the box that pops up, select the ext4 journalling file system, and in mount point, just add a single &#8220;/&#8221;
