...
categories:
  ...
  - Essays
---
Ubuntu is the most popular, and most-widely-used Distribution of Linux present. Based on Debian, it too is open-source, but unlike Debian, which is like all about networking, Ubuntu is, well, the _preferred one for normal, home users._
...
[Ultimate Edition](http://ultimateedition.info/), with it&#8217;s re-designed logo, comes with a huge range of programs, including GIMP, Inkskape, and even a Virtualization tool: Qemulator. Mint and UE though _heavily_ based on Ubuntu, were both launched as Independent, stand-alone OSs, and well, UE is a project that deserves some credit, and is a great choice for newbies, who&#8217;ve just switched to Linux, or normal users, who cant afford WIndows or Mac.
