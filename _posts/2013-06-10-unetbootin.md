...
UNetbootin either makes use of ISO images of distributions present in your computer, and if in case you are short of them too, it downloads the respective image from the internet, and then uses it to burn to your DVD, or perform the _frugal-install, (i.e._ if by any chance you have to resort to that level.)